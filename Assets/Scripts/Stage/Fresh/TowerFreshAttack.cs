...
public class TowerFreshAttack : MonoBehaviour
{
    [SerializeField]
    ...
    private IEnumerator Attack(){
        while(true){
            ...
            if(AttackTarget != null){
                ...
                _bullet.GetComponent<BulletFreshMove>().TargetSet(AttackTarget.transform);
                _bullet.GetComponent<BulletFreshMove>().BulletSetUp(gameObject.transform.parent.gameObject);
            }
