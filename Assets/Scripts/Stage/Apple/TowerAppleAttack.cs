...
public class TowerAppleAttack : MonoBehaviour
{
    [SerializeField]
    ...
    private IEnumerator Attack(){
        while(true){
            ...
            if(AttackTarget != null){
                ...
                _bullet.GetComponent<BulletAppleMove>().TargetSet(AttackTarget.transform);
                _bullet.GetComponent<BulletAppleMove>().BulletSetUp(gameObject.transform.parent.gameObject);
            }
